...
class HeritageContentSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $posts = [
            ...
            ['slug' => 'millets-back-on-the-plate', 'title' => 'Millets, back on the Indian plate', 'category' => 'Wellness', 'excerpt' => 'Foxtail, little, barnyard, ragi — how to swap one meal a day to millets without anyone at the table noticing.', 'image' => $img('1574323347407-f5e1ad6d020b', 1400, 900), 'read_time' => 4, 'body' => '<p>Millets were the everyday grain of most of India until polished rice and wheat took over. They are low-GI, high in fibre and grow on rain alone. Start with ragi dosa or foxtail upma — both taste familiar — and move to millet khichdi and pulao once the family is used to the nutty flavour.</p>'],
            ['slug' => 'raw-honey-crystallises', 'title' => 'Why raw honey crystallises (and why that is good)', 'category' => 'Stories', 'excerpt' => 'Crystallised honey is not spoilt honey. It is the surest sign that nothing was heated, filtered or added.', 'image' => $img('1471943311424-646960669fbc', 1400, 900), 'read_time' => 3, 'body' => '<p>Raw honey is a supersaturated sugar solution with pollen and wax particles in it. In winter the glucose settles around those particles and the jar turns creamy and opaque. Stand the jar in warm water for ten minutes to loosen it — never microwave it, which destroys the enzymes you paid for.</p>'],
