...
<div class="grid gap-3 sm:grid-cols-2">
    <label><span class="label">Label</span><input name="label" value="{{ $v('label') }}" placeholder="Home, Office…" class="field"></label>
    <label><span class="label">Full name</span><input name="name" required value="{{ $v('name') }}" class="field"></label>
    ...
    <label class="sm:col-span-2"><span class="label">Landmark, area</span><input name="line2" value="{{ $v('line2') }}" class="field"></label>
    ...
    <label><span class="label">Phone</span><input name="phone" value="{{ $v('phone') }}" class="field" inputmode="tel"></label>
