...
<div {{ $attributes->class('card flex flex-col items-center px-6 py-12 text-center') }}>
    <span class="grid h-16 w-16 place-items-center rounded-full bg-paper text-mist"><x-ico :name="$icon" :size="28" :stroke="1.5" /></span>
    <p class="mt-4 text-lg font-extrabold">{{ $title }}</p>
