@props(['name', 'size' => 18, 'stroke' => 1.6])
@php
$paths = [
    'badge' => '<path d="M12 3l2.4 1.7 2.9-.3 1 2.8 2.5 1.5-.7 2.8 1.6 2.5-2.1 2-.1 2.9-2.8.9-1.5 2.5-2.8-.8L12 21l-2.4-1.5-2.8.8-1.5-2.5-2.8-.9-.1-2.9-2.1-2 1.6-2.5-.7-2.8L3.7 4.2l1-2.8 2.9.3L12 3z"/><path d="m9 12 2 2 4-4"/>',
    'diamond' => '<path d="M12 3l9 9-9 9-9-9 9-9z"/>',
    'quote' => '<path d="M7 7h4v6H5V9a2 2 0 0 1 2-2zM17 7h4v6h-6V9a2 2 0 0 1 2-2z"/><path d="M9 13c0 3-2 4-4 4M19 13c0 3-2 4-4 4"/>',
