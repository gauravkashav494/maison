...
<div x-data x-show="$store.app.showInstall" x-cloak x-transition class="above-tabs px-3 pb-2 lg:hidden">
    <div class="flex items-center gap-3 rounded-2xl border border-line bg-white p-3 shadow-float">
        <img src="/templates/plumbing/icon-192.png" alt="" class="h-11 w-11 shrink-0 rounded-xl">
        <div class="min-w-0 flex-1">
            <p class="text-sm font-bold leading-tight">Add {{ template()->pwa()['name'] ?? ($site['name'] ?? config('app.name')) }} to your home screen</p>
